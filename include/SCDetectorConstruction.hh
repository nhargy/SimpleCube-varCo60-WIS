...
private:
    ...
    /* Pb Box  */
    G4LogicalVolume*   logic_PbBox = nullptr;
    G4VPhysicalVolume* phys_PbBox  = nullptr;

    /* Pb Tube */
    G4LogicalVolume*   logic_PbTube = nullptr;
    G4VPhysicalVolume* phys_PbTube  = nullptr;

    /* == Special Coordinates  ==*/
    G4double zpos_Plate = 0.;
    G4double zpos_PbBox = 0.;
